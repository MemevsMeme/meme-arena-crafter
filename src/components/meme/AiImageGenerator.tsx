...
const AiImageGenerator: React.FC<AiImageGeneratorProps> = ({
  ...
  const handleImageGeneration = () => {
    ...
    toast({
      ...
      description: "This might take up to 45 seconds with Google's Imagen model",
    });
    ...
    <div>
      ...
      {isGeneratingAIImage && (
        <div className="flex flex-col items-center justify-center p-8">
          ...
          <p className="mt-4 text-sm text-muted-foreground">Creating your meme image with Google's Imagen...</p>
