...
export const DAILY_CHALLENGES: Prompt[] = [
  ...
  {
    id: 'jun-17',
    text: "Father's Day Gift Shopping Panic",
    theme: "holiday",
    tags: ["fathersday", "gifts", "panic"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-18',
    text: "Summertime Office Dress Code Confusion",
    theme: "work",
    tags: ["office", "dress code", "summer"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-19',
    text: "When The Barbecue Gets Out Of Control",
    theme: "food",
    tags: ["bbq", "summer", "cooking"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-20',
    text: "First Day Of Summer Expectations vs. Reality",
    theme: "seasonal",
    tags: ["summer", "solstice", "expectations"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-21',
    text: "When You Can't Remember What Day It Is During Summer Break",
    theme: "seasonal",
    tags: ["summer", "vacation", "time"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-22',
    text: "Finding Out Your Air Conditioner Is Broken On The Hottest Day",
    theme: "home",
    tags: ["ac", "summer", "heat"],
    active: true,
    startDate: new Date(),
  ...
  {
    id: 'jun-23',
    text: "When Everyone Posts Their Vacation Photos And You're At Work",
    theme: "social media",
    tags: ["vacation", "work", "fomo"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-24',
    text: "Trying To Sleep During A Heat Wave",
    theme: "health",
    tags: ["sleep", "heat", "summer"],
    active: true,
    startDate: new Date(),
  ...
  {
    id: 'jun-25',
    text: "Summer Road Trip Car Games Gone Wrong",
    theme: "travel",
  ...
  {
    id: 'jun-26',
    text: "When The Public Pool Is Too Crowded",
    theme: "summer",
    tags: ["pool", "crowds", "swimming"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-27',
    text: "Summer Picnic vs. Insect Invasion",
    theme: "outdoor",
    tags: ["picnic", "bugs", "summer"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-28',
    text: "When Your Neighbors Start Mowing At 7AM On Saturday",
    theme: "neighborhood",
    tags: ["mowing", "noise", "weekend"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-29',
    text: "Summer Barbeque Invite Anxiety",
    theme: "social",
    tags: ["bbq", "anxiety", "social"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  },
  {
    id: 'jun-30',
    text: "Halfway Through The Year Resolutions Check",
    theme: "motivation",
    tags: ["resolutions", "midyear", "goals"],
    active: true,
    startDate: new Date(),
    endDate: new Date(new Date().getTime() + 86400000)
  }
...
export const getDailyPrompt = (): Prompt => {
  return getDailyChallenge(DAILY_CHALLENGES, getCurrentDayOfYear());
};
